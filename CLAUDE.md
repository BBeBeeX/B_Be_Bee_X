...
This file provides concise, agent-focused guidance for working in this monorepo.
...
These classes map to the UIKit color variables (see  `apps/desktop/AGENTS.md`).
...
- Prefer spring presets from `@b_be_bee/components/constants/spring.js` (`Spring.presets.smooth|snappy|bouncy`).
...
- `packages/plugin/CLAUDE.md` covers plugin host/runtime utilities.
